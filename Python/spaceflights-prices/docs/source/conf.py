...
# spaceflights_prices documentation build
...
from spaceflights_prices import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_prices"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_pricesdoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_prices.tex",
        "spaceflights_prices Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_prices",
        "Project spaceflights_prices codebase.",
        "Data-Science",
    )
]
