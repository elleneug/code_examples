exit# spaceflights_prices

## Overview

This is a Kedro project for the [spaceflights tutorial](https://kedro.readthedocs.io/en/stable/tutorial/spaceflights_tutorial.html), which was generated using `Kedro 0.18.7`.
...
### Project: 
We want to construct a model that predicts the price for each trip to the Moon and the corresponding return flight.
