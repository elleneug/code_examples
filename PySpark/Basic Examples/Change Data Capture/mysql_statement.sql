CREATE SCHEMA elena_schema;
drop table elena_schema.Persons
CREATE TABLE elena_schema.Persons (
    PersonID int,
...
INSERT INTO elena_schema.Persons VALUES
...
Select * from elena_schema.Persons where City like "Denver";



///////////////////// Commands for CDC
Select * from elena_schema.Persons
update elena_schema.Persons set FullName = 'ABC XYZ' where PersonId = 7,
INSERT INTO elena_schema.Persons VALUES (130,'Alica Bing','New York'),
INSERT INTO elena_schema.Persons VALUES (131,'Malinda Bing','Detroit'),
INSERT INTO elena_schema.Persons VALUES (132,'Chandler Bing','Portland'),
update elena_schema.Persons set FullName = 'ABC XYZ' where PersonId = 8,
DELETE FROM elena_schema.Persons where PersonId = 10,